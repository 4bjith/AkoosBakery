...
import { Users, ShoppingCart, Package, FileText, Menu, X, User, LogOut, Briefcase } from 'lucide-react';
...
export default function StaffLayout() {
  ...
  const navItems = [
    ...
    { name: 'Place Order', path: '/staff/orders/place', icon: ShoppingCart },
    { name: 'Orders', path: '/staff/orders', icon: Package },
    ...
    <div className="fixed inset-0 bg-[#fdfbf9] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-white border-b border-[#f0e9e1] sticky top-0 z-30">
        <div className="flex items-center gap-2">
          <Briefcase className="w-6 h-6 text-[#c79261]" />
          <span className="font-bold text-[#2c2a29]">Staff Portal</span>
        </div>
      ...
      >
        <div className="p-6 flex items-center gap-3 border-b border-[#f0e9e1]">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-wider text-[#6b615a] font-semibold">Staff Portal</p>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-[#f0e9e1]">
          <div className="flex items-center gap-3 px-3 py-3 mb-2 rounded-lg bg-[#fdfbf9] border border-[#f0e9e1] text-sm">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-[#6b615a] truncate">{user?.staffId || 'Staff'}</p>
            </div>
          </div>
          <Link
            to="/profile"
